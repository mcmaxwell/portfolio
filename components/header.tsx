...
export default function Header() {
    ...
    return (
        <header className='z-[999] relative'>
            <nav className='bg-black bg-opacity-20  backdrop-blur-[0.5rem] rounded-full dark:bg-white dark:bg-opacity-20 flex fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
